...
const OrderTable = ({ vendorName, data, handleClickUp }) => {
  ...
  return (
    <div className="text-center py-4 my-4 bg-slate-400 border-solid shadow-2xl shadow-slate-900 hover:scale-105">
